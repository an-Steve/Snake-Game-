...
# ------------------ Fonctions Jeu ------------------
def dessiner_decor():
    """Dessine un fond quadrillé style damier"""
    for y in range(0, HAUTEUR, TAILLE_BLOC):
        for x in range(0, LARGEUR, TAILLE_BLOC):
            if (x // TAILLE_BLOC + y // TAILLE_BLOC) % 2 == 0:
                pygame.draw.rect(fenetre, VERT_FONCE, (x, y, TAILLE_BLOC, TAILLE_BLOC))
            else:
                pygame.draw.rect(fenetre, VERT_CLAIR, (x, y, TAILLE_BLOC, TAILLE_BLOC))
